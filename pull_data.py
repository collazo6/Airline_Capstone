...
def get_data(engine=create_engine('postgresql://manuelcollazo:manuelcollazo@localhost:5432/airlines')):
    """
    OUTPUT:
    x_df: airline dataframes created by extracting data from corresponding
        airline table in psql database
    ...
    dfs = [southwest_df, american_df, delta_df, united_df, ana_df,
           japan_df, qatar_df]
